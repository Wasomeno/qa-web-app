  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            'fixed inset-y-0 z-30 hidden h-svh w-[--sidebar-width] transition-[left,right,width] duration-300 ease-in-out md:flex',
            side === 'left'
...
>(
  (
    ...
    const Comp = asChild ? Slot : 'button';
    const { isMobile, state, portalContainer } = useSidebar();
